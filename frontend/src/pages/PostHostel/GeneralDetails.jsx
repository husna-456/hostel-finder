        ...
        <div className="max-w-4xl mx-auto">
          <div className="bg-white rounded-3xl shadow-xl overflow-hidden">
            <div className="bg-gradient-to-r from-purple-600 to-indigo-600 px-8 py-10 text-center">
              <h2 className="text-3xl font-bold text-white">Hostel Details</h2>
              <p className="text-purple-100 mt-2">Fill in the basic information about your hostel</p>
            </div>

            <form className="p-8 lg:p-12 space-y-8" onSubmit={handleNext}>
              {/* Hostel Name */}
              <div>
                ...
                <input
                  ...
                  className={`w-full px-5 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 transition ${errors.hostelName ? "border-red-500" : "border-gray-300"
                    }`}
              ...
              <div>
                ...
                <input
                  ...
                  className={`w-full px-5 py-3 border rounded-xl bg-gray-100 cursor-not-allowed ${errors.ownerName ? "border-red-500" : "border-gray-300"
                    }`}
              ...
              <div>
                ...
                <select
                  ...
                  onChange={handleChange}
                  className={`w-full px-5 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 transition ${errors.hostelType ? "border-red-500" : "border-gray-300"
                    }`}
                >
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-5 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 transition ${errors.contactPhone ? "border-red-500" : "border-gray-300"
                    }`}
              ...
              <div>
                ...
                <input
                  ...
                  onChange={handleChange}
                  className={`w-full px-5 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 transition ${errors.address ? "border-red-500" : "border-gray-300"
                    }`}
              ...
              <div>
                ...
                <textarea
                  ...
                  onChange={handleChange}
                  rows="5"
                  className={`w-full px-5 py-3 border rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 transition resize-none ${errors.description ? "border-red-500" : "border-gray-300"
                    }`}
              ...
              <div className="border-t border-gray-200 pt-6">
                ...
                <p className="text-sm text-gray-500 mb-4">Enter your mobile wallet numbers for receiving advance payments from students.</p>
                ...
                <div className="grid md:grid-cols-2 gap-6">
                  <div>
                    ...
                    <input
                      ...
                      onChange={handleChange}
                      className="w-full px-5 py-3 border border-gray-300 rounded-xl focus:outline-none focus:ring-2 focus:ring-purple-500 transition"
              ...
              <div>
                ...
                <label
                  ...
                  className="flex flex-col items-center justify-center w-full h-64 border-4 border-dashed border-purple-200 rounded-2xl cursor-pointer bg-purple-50 hover:bg-purple-100 transition"
                >
                    ...
                    {pictures.map((img, i) => (
                      <div key={i} className="relative group">
                        <img
                          src={img.preview}
                          alt={`Preview ${i + 1}`}
                          className="w-full h-40 object-cover rounded-xl shadow-md cursor-pointer transition transform group-hover:scale-105"
              ...
              <div className="flex justify-between pt-8">
                {onPrevious && (
                  <button
                    type="button"
                    onClick={onPrevious}
                    className="px-8 py-3 bg-gray-200 text-gray-700 rounded-xl font-medium hover:bg-gray-300 transition"
                  >
                    Previous
                  </button>
                )}
                <button
                  type="submit"
                  className="px-10 py-3 bg-gradient-to-r from-purple-600 to-indigo-600 text-white rounded-xl font-semibold hover:from-purple-700 hover:to-indigo-700 transition shadow-lg"
                >
                  Save & Next
                </button>
              </div>
