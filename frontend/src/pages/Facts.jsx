...
const achieveIconMap = { award: Award, shield: Shield, zap: Zap, trend: TrendingUp };
        ...
        <div className="grid grid-cols-2 lg:grid-cols-4 gap-4 md:gap-6">
          {stats?.map((stat, i) => {
            ...
            return (
              ...
              >
                <div className={`w-11 h-11 rounded-2xl flex items-center justify-center mx-auto mb-4 transition-transform duration-200 group-hover:scale-110 ${bgMap[i % bgMap.length]}`}>
        ...
        <div className="max-w-[1100px] mx-auto px-4 md:px-10">
          ...
          <div className="grid md:grid-cols-3 gap-5 md:gap-6">
            {achievements?.map((a, i) => {
              const Icon = achieveIconMap[a.icon] || Award;
              return (
